  ...
  try {
    const { text } = await generateText({
      ...
      soluciones para optimizar la configuración del sistema según el presupuesto y necesidades del usuario. También responderás preguntas técnicas sobre construcción, actualización y
       ...
       del usuario proporcionando información técnica comprensible. Ahora, procede a analizar los siguientes componentes que te proporcionaré a continuación, tu respuesta debe ser toda en un solo texto 
       sin Caracteres especiales como * - # u otros, debe ser solo texto, tu respuesta no debe tener mas de 100 palabras: ${result}`,
    });
